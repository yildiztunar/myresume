...
const { t } = useTranslation();
    ...
    return (
      ...
      <div className='flex flex-row gap-x-8'>
        <div className="flex flex-col text-tiny lg:text-base text-wrap text-left text-greentext gap-y-8 ">
        <div>{t('birthday')}</div>
        ...
        <div className="flex flex-col text-tiny lg:text-base text-wrap text-left text-whitetext gap-y-8">
